...
class EmployeeInformationPage(BaseMethods):
    ...
    def get_row_info(self, row_number):
        ...
        return {
            ...
            'job_title' : row.find_element(By.XPATH, ".//td[5]").text,
            'employment_status' : row.find_element(By.XPATH, ".//td[6]").text,
            'sub_unit' : row.find_element(By.XPATH, ".//td[5]").text,
            'supervisor' : row.find_element(By.XPATH, ".//td[5]").text
            }
